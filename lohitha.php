	...
	<body class="loader">
		...
		<main class="animsition-overlay" data-animsition-overlay="true">
			...
			<section id="up" class="page-head flex-min-height-box dark-bg-1">
				<!-- page-head-bg -->
				<div class="page-head-bg overlay-loading2" style="background-image: url(assets/images/pj/LohithaMockup.jpg);"></div>
			  			...
			  			<div class="six-columns six-offset">
				  			<div class="content-left-margin-40">
				  				<h2 class="large-title">
									<span class="load-title-fill tr-delay03" data-text="Lohitha">Lohitha</span><br>
									<span class="load-title-fill tr-delay04" data-text="FMCG Company">FMCG Company</span><br>
									<span class="load-title-fill tr-delay05" data-text="Kakinada">Kakinada</span>
								</h2>
								<ul class="d-flex-wrap top-margin-20">
									<li class="small-title-oswald text-height-20 load-title-fill tr-delay06 top-margin-10" data-text="Lohitha">Lohitha</li>
									...
									<li class="small-title-oswald text-height-20 load-title-fill tr-delay08 top-margin-10" data-text="ROLE: FMCG Branding">ROLE: FMCG Branding </li>
								</ul>
				  			</div>
			  			</div><!-- column end -->
					...
					<div class="flex-container container small top-padding-120 bottom-padding-60 project-content">
						...
						<div class="eight-columns bottom-padding-60">
							<div class="content-left-margin-20">
								<p class="p-style-large text-color-4">Pattabhi agro foods private limited (Lohitha brand), is an FMCG company is engaged in paddy purchases, processing, milling and grading of rice and its bi-products </p>
							</div>
						</div><!-- column end -->
					</div><!-- flex-container end -->
				</div><!-- flex-min-height-inner end -->
			...
			<div class="light-bg-1 top-padding-120 bottom-padding-60" data-midnight="black">
				...
				<div class="four-columns bottom-padding-60">
					...
					<div class="four-columns bottom-padding-60">
						<div class="content-right-margin-20">
							<a class="photo-popup pointer-zoom" href="assets/images/Mockups/Lohitha/gf.jpg">
								<img src="assets/images/Mockups/Lohitha/gf.jpg" alt="title">
							</a>
						</div>
					</div><!-- column end -->
					<!-- column start -->
					<div class="four-columns bottom-padding-60">
						<div class="content-left-right-margin-10">
							<a class="photo-popup pointer-zoom" href="assets/images/Mockups/Lohitha/h.jpg">
								<img src="assets/images/Mockups/Lohitha/h.jpg" alt="title">
							</a>
						</div>
					</div><!-- column end -->
					<!-- column start -->
					<div class="four-columns bottom-padding-60">
						<div class="content-left-margin-20">
							<a class="photo-popup pointer-zoom" href="assets/images/Mockups/Lohitha/tra.jpg">
								<img src="assets/images/Mockups/Lohitha/tra.jpg" alt="title">
							</a>
						</div>
					</div><!-- column end -->
				</div><!-- flex-container end -->
