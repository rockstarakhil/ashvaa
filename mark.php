	...
	<body class="loader">
		...
		<main class="animsition-overlay" data-animsition-overlay="true">
			...
			<section id="up" class="page-head flex-min-height-box dark-bg-2">
				<!-- page-head-bg -->
				<div class="page-head-bg overlay-loading2" style="background-image: url(assets/images/blog/mark.jpg);"></div>
			  			...
			  			<div class="six-columns six-offset">
				  			<div class="content-left-margin-40">
				  				<h2 class="large-title">
									<span class="load-title-fill tr-delay03" data-text="The Indian advertising">The Indian advertising</span><br>
									<span class="load-title-fill tr-delay04" data-text="industry is ">industry is </span><br>
									<span class="load-title-fill tr-delay05" data-text="witnessing a large">witnessing a large</span>
								</h2>
				...
				<div class="flex-container">
					...
					<div class="eight-columns">
						...
						<div class="light-bg-2">
							<a class="photo-popup pointer-zoom" href="assets/images/blog/mark.jpg">
								<img src="assets/images/blog/mark.jpg" alt="title">
							</a>
							<!-- content-margin-block start -->
							<div class="content-margin-block">
								<!-- entry-content start -->
								<article class="entry-content">
									<p class="p-style-medium text-color-1">The Indian advertising industry is witnessing a large-size shift. because of low 4G data rates and affordable broadband plans, squandering of entertainment has shifted from television to mobile phone. This shift has meant a challenge for traditional advertising agencies, as they have the implied liability of scaling up to communication 
</p>
									<p class="p-style-medium text-color-1">communication that’s tailored and hooked to their favourite handheld gadget. as we are much familiar, for the last few years this shift has propelled new genre of Digital Advertising Agencies.
Interestingly, this has surfaced the way for categorization of creative setups – the 
</p>
									<blockquote class="quote-content">
										<p class="p-style-bold text-justify text-color-4">‘Digital Advertising’ vertical of a big agency network; the ‘in-house agency’ of a big brand that can afford to have its own creative hub; and fist-sized digital boutiques taking up all things and any-thing Digital. What’s also to be observed is that with Print advertising taking a backseat and Digital media taking the front seat, the need for digital content has arrived. Because today, a brand’s presence on Social Media 
</p>
									</blockquote>
									<h2 class="title-style text-color-1 top-margin-30 text-center"></h2>
									<p class="p-style-medium text-color-1">(Facebook, Instagram, Twitter and TikTok) platforms. Given this change, today there are more agencies ready to handle the Digital communication of a business. Let’s also consider the fact that Digital as a medium is more quantifiable and versatile than traditional media. But then, there’s more to Digital than just Facebook, Instagram, Twitter and LinkedIn. Digital is fast beginning to take different forms and formats in India giving us various marketing opportunities: 
</p>
									<!-- post-img-flex start -->
