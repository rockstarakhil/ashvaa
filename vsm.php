	...
	<body class="loader">
		...
		<main class="animsition-overlay" data-animsition-overlay="true">
			...
			<section id="up" class="page-head flex-min-height-box dark-bg-1">
				<!-- page-head-bg -->
				<div class="page-head-bg overlay-loading2" style="background-image: url(assets/images/pj/V2.jpg);"></div>
			  			...
			  			<div class="six-columns six-offset">
				  			<div class="content-left-margin-40">
				  				<h2 class="large-title">
									<span class="load-title-fill tr-delay03" data-text="VSM GROUP">VSM GROUP</span><br>
									<span class="load-title-fill tr-delay04" data-text="EDUCATIONAL institutions">EDUCATIONAL institutions</span><br>
									<span class="load-title-fill tr-delay05" data-text="RAMACHANDRAPURAM">RAMACHANDRAPURAM</span>
								</h2>
								<ul class="d-flex-wrap top-margin-20">
									<li class="small-title-oswald text-height-20 load-title-fill tr-delay06 top-margin-10" data-text="VSM">VSM</li>
									<li class="small-title-oswald text-height-20 load-title-fill tr-delay07 top-margin-10" data-text="YEAR: 2015">YEAR:2015</li>
									<li class="small-title-oswald text-height-20 load-title-fill tr-delay08 top-margin-10" data-text="ROLE:EDUCATION">ROLE:EDUCATION</li>
								</ul>
				  			</div>
			  			</div><!-- column end -->
					...
					<div class="flex-container container small top-padding-120 bottom-padding-60 project-content">
						...
						<div class="eight-columns bottom-padding-60">
							<div class="content-left-margin-20">
								<p class="p-style-large text-color-4">We are roped in as a branding agency for VSM while they were in the process of re-branding themselves as a highly preferable college for engineering aspirants. We as a creative agency gave them necessary suggestions in visual identity systems, choice of colour palette. Designed the flyers and hoarding in a innovative way also had suggested the best visible places for their target audience. This campaign has gained them a great visibility and brought them 100% admissions.  The journey continued successfully with many milestones.
</p>
							</div>
						</div><!-- column end -->
					</div><!-- flex-container end -->
			...
			<div class="light-bg-1 top-padding-120 bottom-padding-60" data-midnight="black">
				...
				<div class="flex-container container project-content">
					...
					<div class="four-columns bottom-padding-60">
						<div class="content-right-margin-20">
							<a class="photo-popup pointer-zoom" href="assets/images/Mockups/vsm/V1.jpg">
								<img src="assets/images/Mockups/vsm/V1.jpg" alt="title">
							</a>
						</div>
					</div><!-- column end -->
					<!-- column start -->
					<div class="four-columns bottom-padding-60">
						<div class="content-left-right-margin-10">
							<a class="photo-popup pointer-zoom" href="assets/images/Mockups/vsm/V2.jpg">
								<img src="assets/images/Mockups/vsm/V2.jpg" alt="title">
							</a>
						</div>
					</div><!-- column end -->
					<!-- column start -->
					<div class="four-columns bottom-padding-60">
						<div class="content-left-margin-20">
							<a class="photo-popup pointer-zoom" href="assets/images/Mockups/vsm/V3.jpg">
								<img src="assets/images/Mockups/vsm/V3.jpg" alt="title">
							</a>
						</div>
					</div><!-- column end -->
				</div><!-- flex-container end -->
			...
			<div>
	<!--			<img src="assets/images/projects/pexels-photo-257699.jpg" alt="title">
			</div>
			...
			<div class="light-bg-1 top-padding-120 bottom-padding-60" data-midnight="black">
				...
				<div class="container small">
					<div class="bottom-padding-60">
						<a class="photo-popup pointer-zoom" href="assets/images/projects/pexels-photo-109003.jpg">
							<img src="assets/images/projects/pexels-photo-109003.jpg" alt="title">
						</a>
					</div>
					<div class="bottom-padding-60">
						<a class="photo-popup pointer-zoom" href="assets/images/projects/pexels-photo-688988.jpg">
							<img src="assets/images/projects/pexels-photo-688988.jpg" alt="title">
						</a>
					</div>
					<div class="bottom-padding-60">
						<a class="photo-popup pointer-zoom" href="assets/images/projects/pexels-photo-724921.jpg">
							<img src="assets/images/projects/pexels-photo-724921.jpg" alt="title">
						</a>
					</div>
					<div class="bottom-padding-60">
						<a class="photo-popup pointer-zoom" href="assets/images/projects/pexels-photo-916015.jpg">
							<img src="assets/images/projects/pexels-photo-916015.jpg" alt="title">
						</a>
					</div>
				</div><!-- container end -->
			</div><!-- light-bg-1 end -->
		...
		<!--	<div>
				<img src="assets/images/projects/pexels-photo-1762539.jpg" alt="title">
			</div>
		...
		<!--	<div class="text-center top-bottom-padding-120 red-bg" data-midnight="black">
				<a href="project.php" class="pointer-large animsition-link overlay-btn-box">
...
<!-- Mirrored from www.nurseitmukaytegin.com/envato-templates/xen/project.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Mar 2020 06:44:36 GMT -->
</html>