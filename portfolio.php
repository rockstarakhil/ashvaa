			  			...
			  			<div class="six-columns six-offset">
				  			<div class="content-left-margin-40">
								...
								<p class="p-style-bold-up text-height-20 d-flex-wrap">
									<span class="load-title-fill tr-delay08" data-text="XOXO fam brunch">We Design Experience</span>
									<span class="load-title-fill tr-delay09" data-text="retro intelligentsia">that connect</span>
									<span class="load-title-fill tr-delay10" data-text="live-edge vegan">with people</span>
								</p>
				  			</div>
			  			</div><!-- column end -->
							...
							<div class="flex-container container small">
								...
								<div class="six-columns top-padding-60">
									<a href="jain.php" class="portfolio-content-bg-box pointer-large hover-box hidden-box animsition-link">
										<div class="portfolio-content-bg hover-img overlay-anim-box2 overlay-dark-bg-2" data-animation="overlay-anim2" style="background-image:url(assets/images/Mockups/Jain/adv.jpg)"></div>
									</a>
								</div><!-- column end -->
							</div><!-- flex-container end -->
							...
							<div class="flex-container reverse container small">
								...
								<div class="six-columns top-padding-60">
									<a href="lohitha.php" class="portfolio-content-bg-box pointer-large hover-box hidden-box animsition-link">
										<div class="portfolio-content-bg hover-img overlay-anim-box2 overlay-dark-bg-2" data-animation="overlay-anim2" style="background-image:url(assets/images/Mockups/Lohitha/tra.jpg)"></div>
									</a>
								</div><!-- column end -->
								<!-- column start -->
								<div data-animation-container class="six-columns">
...
We have been entrusted the task of expanding the reach on the online world and also connect to the target audience	
								...
								<div class="six-columns top-padding-60">
									<a href="maruthi.php" class="portfolio-content-bg-box pointer-large hover-box hidden-box animsition-link">
										<div class="portfolio-content-bg hover-img overlay-anim-box2 overlay-dark-bg-2" data-animation="overlay-anim2" style="background-image:url(assets/images/Mockups/Maruthi/mockup2.jpg)"></div>
									</a>
								</div><!-- column end -->
							</div><!-- flex-container end -->
						</div><!-- portfolio-content-inner end -->
							...
							<div class="flex-container reverse container small">
								...
								<div class="six-columns top-padding-60">
									<a href="pydah.php" class="portfolio-content-bg-box pointer-large hover-box hidden-box animsition-link">
										<div class="portfolio-content-bg hover-img overlay-anim-box2 overlay-dark-bg-2" data-animation="overlay-anim2" style="background-image:url(assets/images/Mockups/pydah/mockup.jpg)"></div>
									</a>
								</div><!-- column end -->
								<!-- column start -->
								<div data-animation-container class="six-columns">
					...
					<div class="portfolio-content flex-min-height-box">
						...
						<div class="portfolio-content-inner flex-min-height-inner">
							...
							<div class="flex-container container small">
								...
								<!-- column start -->
								<div class="six-columns top-padding-60">
									<a href="sid.php" class="portfolio-content-bg-box pointer-large hover-box hidden-box animsition-link">
										<div class="portfolio-content-bg hover-img overlay-anim-box2 overlay-dark-bg-2" data-animation="overlay-anim2" style="background-image:url(assets/images/Mockups/sid/mockup1.jpg)"></div>
									</a>
								</div><!-- column end -->
							</div><!-- flex-container end -->
						</div><!-- portfolio-content-inner end -->
							...
							<div class="flex-container reverse container small">
								...
								<div class="six-columns top-padding-60">
									<a href="project.php" class="portfolio-content-bg-box pointer-large hover-box hidden-box animsition-link">
										<div class="portfolio-content-bg hover-img overlay-anim-box2 overlay-dark-bg-2" data-animation="overlay-anim2" style="background-image:url(assets/images/Mockups/mt/NCL.jpg)"></div>
									</a>
								</div><!-- column end -->
								<!-- column start -->
								<div data-animation-container class="six-columns">
...
<!-- Mirrored from www.nurseitmukaytegin.com/envato-templates/xen/portfolio.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Mar 2020 06:41:34 GMT -->
</html>