	...
	<body class="loader">
		...
		<main class="animsition-overlay" data-animsition-overlay="true">
			...
			<section id="up" class="page-head flex-min-height-box dark-bg-1">
				<!-- page-head-bg -->
				<div class="page-head-bg overlay-loading2" style="background-image: url(assets/images/pj/R3.jpg);"></div>
			  			...
			  			<div class="six-columns six-offset">
				  			<div class="content-left-margin-40">
				  				<h2 class="large-title">
									<span class="load-title-fill tr-delay03" data-text="RAJDEEP SILVERZ">RAJDEEP SILVERZ</span><br>
									<span class="load-title-fill tr-delay04" data-text="SILVER SHOW ROOM">SILVER SHOW ROOM</span><br>
									<span class="load-title-fill tr-delay05" data-text="Kakinada">Kakinada</span>
								</h2>
								<ul class="d-flex-wrap top-margin-20">
									<li class="small-title-oswald text-height-20 load-title-fill tr-delay06 top-margin-10" data-text="Raj Silverz">Retail Branding</li>
									<li class="small-title-oswald text-height-20 load-title-fill tr-delay07 top-margin-10" data-text="YEAR: 2015-Present">YEAR: 2017- present</li>
					...
					<div class="flex-container container small top-padding-120 bottom-padding-60 project-content">
						...
						<div class="eight-columns bottom-padding-60">
							<div class="content-left-margin-20">
								<p class="p-style-large text-color-4">Rajdeep Silverz, being a pioneer in the silver business in Kakinada for over 25 years wanted to expand their business horizontally taking up different varieties silver. We came into their mind when they wanted to name their different brands that they wanted to begin. We helped them with naming their brands such as grace, vintaz, payal, Daivik etc, we also involved in environment design and did the much need work which helped them enhance look and feel that they always dreamed of.
</p>
							</div>
						</div><!-- column end -->
					</div><!-- flex-container end -->
			...
			<div class="light-bg-1 top-padding-120 bottom-padding-60" data-midnight="black">
				...
				<!--		<div class="content-left-margin-10">
					...
					<div class="four-columns bottom-padding-60">
						<div class="content-right-margin-20">
							<a class="photo-popup pointer-zoom" href="assets/images/Mockups/raj/R1.jpg">
								<img src="assets/images/Mockups/raj/R1.jpg" alt="title">
							</a>
						</div>
					</div><!-- column end -->
					<!-- column start -->
					<div class="four-columns bottom-padding-60">
						<div class="content-left-right-margin-10">
							<a class="photo-popup pointer-zoom" href="assets/images/Mockups/raj/R2jpg">
								<img src="assets/images/Mockups/raj/R2.jpg" alt="title">
							</a>
						</div>
					</div><!-- column end -->
					<!-- column start -->
					<div class="four-columns bottom-padding-60">
						<div class="content-left-margin-20">
							<a class="photo-popup pointer-zoom" href="assets/images/Mockups/raj/R3.jpg">
								<img src="assets/images/Mockups/raj/R3.jpg" alt="title">
							</a>
						</div>
					</div><!-- column end -->
				</div><!-- flex-container end -->
...
<!-- Mirrored from www.nurseitmukaytegin.com/envato-templates/xen/project.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Mar 2020 06:44:36 GMT -->
</html>