	...
	<body class="loader">
		...
		<main class="animsition-overlay" data-animsition-overlay="true">
			...
			<section id="up" class="page-head flex-min-height-box dark-bg-1">
				<!-- page-head-bg -->
				<div class="page-head-bg overlay-loading2" style="background-image: url(assets/images/pj/pyd.jpg);"></div>
...
Our well-strategic and relevant content and designs gave them a consistent stream of high-quality leads for conversion.
			...
			<div class="light-bg-1 top-padding-120 bottom-padding-60" data-midnight="black">
				...
				<div class="flex-container container project-content">
					...
					<div class="four-columns bottom-padding-60">
						<div class="content-right-margin-20">
							<a class="photo-popup pointer-zoom" href="assets/images/Mockups/pydah/a4.jpg">
								<img src="assets/images/Mockups/pydah/a4.jpg" alt="title">
							</a>
						</div>
					</div><!-- column end -->
					<!-- column start -->
					<div class="four-columns bottom-padding-60">
						<div class="content-left-right-margin-10">
							<a class="photo-popup pointer-zoom" href="assets/images/Mockups/pydah/mockup2.jpg">
								<img src="assets/images/Mockups/pydah/mockup2.jpg" alt="title">
							</a>
						</div>
					</div><!-- column end -->
					<!-- column start -->
					<div class="four-columns bottom-padding-60">
						<div class="content-left-margin-20">
							<a class="photo-popup pointer-zoom" href="assets/images/Mockups/pydah/mc.jpg">
								<img src="assets/images/Mockups/pydah/mc.jpg" alt="title">
							</a>
						</div>
					</div><!-- column end -->
				</div><!-- flex-container end -->
