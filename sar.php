	...
	<body class="loader">
		...
		<main class="animsition-overlay" data-animsition-overlay="true">
			...
			<section id="up" class="page-head flex-min-height-box dark-bg-1">
				<!-- page-head-bg -->
				<div class="page-head-bg overlay-loading2" style="background-image: url(assets/images/pj/S2.jpg);"></div>
			  			...
			  			<div class="six-columns six-offset">
				  			<div class="content-left-margin-40">
				  				<h2 class="large-title">
									<span class="load-title-fill tr-delay03" data-text="SARGAMS">SARGAMS</span><br>
								...
								<ul class="d-flex-wrap top-margin-20">
									<li class="small-title-oswald text-height-20 load-title-fill tr-delay06 top-margin-10" data-text="SARGAMS">Retail Branding</li>
									<li class="small-title-oswald text-height-20 load-title-fill tr-delay07 top-margin-10" data-text="YEAR: 2015-Present">YEAR: 2016- present</li>
					...
					<div class="flex-container container small top-padding-120 bottom-padding-60 project-content">
						...
						<div class="eight-columns bottom-padding-60">
							<div class="content-left-margin-20">
								<p class="p-style-large text-color-4">Sargams textiles was an family business running since 50 years in Kakinada. While they wanted to expand their business with an new addition of showroom in the town. We were just roped in for branding collaterals, but seeing our dedication they also consulted us for their showroom environment design. After an extensive research on consumer preferences and tastes we have suggested them the colour palette for the exterior and interior of the showroom and also redesigned required indoor-communications that includes section backdrops, price tags, packaging and reception outlook.
</p>
							</div>
						</div><!-- column end -->
					</div><!-- flex-container end -->
			...
			<div class="light-bg-1 top-padding-120 bottom-padding-60" data-midnight="black">
				...
				<!--		<div class="content-left-margin-10">
					...
					<div class="four-columns bottom-padding-60">
						<div class="content-right-margin-20">
							<a class="photo-popup pointer-zoom" href="assets/images/Mockups/sri/S1.jpg.jpg">
								<img src="assets/images/Mockups/sri/S1.jpg" alt="title">
							</a>
						</div>
					</div><!-- column end -->
					<!-- column start -->
					<div class="four-columns bottom-padding-60">
						<div class="content-left-right-margin-10">
							<a class="photo-popup pointer-zoom" href="assets/images/Mockups/sri/S2.jpg.jpg">
								<img src="assets/images/Mockups/sri/S2.jpg" alt="title">
							</a>
						</div>
					</div><!-- column end -->
					<!-- column start -->
					<div class="four-columns bottom-padding-60">
						<div class="content-left-margin-20">
							<a class="photo-popup pointer-zoom" href="assets/images/Mockups/sri/S3.jpg.jpg">
								<img src="assets/images/Mockups//sri/S3.jpg" alt="title">
							</a>
						</div>
					</div><!-- column end -->
				</div><!-- flex-container end -->
