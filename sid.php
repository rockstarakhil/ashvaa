	...
	<body class="loader">
		...
		<main class="animsition-overlay" data-animsition-overlay="true">
			...
			<section id="up" class="page-head flex-min-height-box dark-bg-1">
				<!-- page-head-bg -->
				<div class="page-head-bg overlay-loading2" style="background-image: url(assets/images/pj/sid.jpg);"></div>
			  			...
			  			<div class="six-columns six-offset">
				  			<div class="content-left-margin-40">
				  				<h2 class="large-title">
									<span class="load-title-fill tr-delay03" data-text="SIDDARTHA MACCS">SIDDARTHA MACCS</span><br>
									<span class="load-title-fill tr-delay04" data-text="Private Sector Bank">Private Sector Bank</span><br>
									<span class="load-title-fill tr-delay05" data-text="Kakinada">Kakinada</span>
								</h2>
								<ul class="d-flex-wrap top-margin-20">
									<li class="small-title-oswald text-height-20 load-title-fill tr-delay06 top-margin-10" data-text="SIDDARTHA MACCS">SIDDARTHA MACCS</li>
									<li class="small-title-oswald text-height-20 load-title-fill tr-delay07 top-margin-10" data-text="YEAR: 2018-Present">YEAR: 2018-Present</li>
									<li class="small-title-oswald text-height-20 load-title-fill tr-delay08 top-margin-10" data-text="ROLE: Banking">ROLE: Banking </li>
								</ul>
				  			</div>
			  			</div><!-- column end -->
					...
					<div class="flex-container container small top-padding-120 bottom-padding-60 project-content">
						...
						<div class="four-columns bottom-padding-60">
							<div class="content-right-margin-20">
								<ul class="text-color-4 xsmall-title-oswald list-dots">
									...
									<li>Logo</li>
									<li>Debit & Credit Card Designs</li>
						...
						<div class="eight-columns bottom-padding-60">
							<div class="content-left-margin-20">
								<p class="p-style-large text-color-4">Siddartha maccs is leading private sector bank, which enables to invests the funds with the criteria of profitability, liquidity and security</p>
							</div>
						</div><!-- column end -->
					</div><!-- flex-container end -->
				</div><!-- flex-min-height-inner end -->
