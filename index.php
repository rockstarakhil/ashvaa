			...
			<ul class="nav-menu dark-bg-1">
				...
				<li class="nav-box nav-bg-change active dropdown-open">
					...
					<ul class="dropdown">
						...
						<li class="nav-box">
							<a href="home_fullscreen.php" class="animsition-link pointer-large">
								<span class="nav-btn" data-text="Fullscreen Bg">Fullscreen Bg</span>
							</a>
						</li>
						<li class="nav-box">
							<a href="home_particles.php" class="animsition-link pointer-large">
				...
				<!--	<ul class="dropdown">
						...
						<li class="nav-box">
							<a href="portfolio_full_screen.php" class="animsition-link pointer-large">
								<span class="nav-btn" data-text="FullScreen">FullScreen</span>
							</a>
						</li>
						<li class="nav-box">
							<a href="portfolio_slider.php" class="animsition-link pointer-large">
								<span class="nav-btn" data-text="Slider 1">Slider 1</span>
							</a>
						</li>
						<li class="nav-box">
							<a href="portfolio_columns_slider.php" class="animsition-link pointer-large">
								<span class="nav-btn" data-text="Slider 2">Slider 2</span>
							</a>
						</li>
						<li class="nav-box">
							<a href="portfolio_filter.php" class="animsition-link pointer-large">
								<span class="nav-btn" data-text="Filter">Filter</span>
							</a>
						</li>
						<li class="nav-box">
							<a href="project.php" class="animsition-link pointer-large">
				...
				<li class="nav-box nav-bg-change dropdown-open">
					...
					<ul class="dropdown">
						...
						<li class="nav-box">
							<a href="single_post.php" class="animsition-link pointer-large">
				...
				<div class="testimonials-slider container small">
					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide text-center">
							<img src="assets/images/testimonials/t5.jpg" alt="author">
							<div class="testimonials-content">
								<p class="text-color-4 p-style-bold">One of the best agencies in Kakinada which is giving the best service in time.</p>
							</div>
							<div class="text-color-1 small-title-oswald">
								Narendra ,<span class="text-color-2">Director, Priya Hotel Management</span>
							</div>
						</div><!-- slide end -->
						<!-- slide start -->
						<div class="swiper-slide text-center">
							<img src="assets/images/testimonials/ideal.png" alt="author">
							<div class="testimonials-content">
								<p class="text-color-4 p-style-bold">Wonderful Team with great commitment they will add life to your work</p>
							</div>
							<div class="text-color-1 small-title-oswald">
								Ranjit Merla  ,<span class="text-color-2">Academic Director, IDEAL Institute</span>
							</div>
						</div><!-- slide end -->
						<!-- slide start -->
						<div class="swiper-slide text-center">
							<img src="assets/images/testimonials/charms.jpg" alt="author">
							<div class="testimonials-content">
								<p class="text-color-4 p-style-bold">One of the affordable marketing agencies & creative minds</p>
							</div>
							<div class="text-color-1 small-title-oswald">
								Krishna Kumari Appasani ,<span class="text-color-2">Director, Charms Beauty Clinic</span>
							</div>
						</div><!-- slide end -->
						<!-- slide start -->
						<div class="swiper-slide text-center">
							<img src="assets/images/testimonials/t4.jpg" alt="author">
							<div class="testimonials-content">
								<p class="text-color-4 p-style-bold">It's a pleasure to be associated with MR.Manikanteswar and team Ashvaa.


Mani is a perfect blend of creativity , professionalism ,patience and customer service ,
he is quite informative on latest requirements of any form for any kind of industry.
Having undertaken a number of projects with him , he  has have listened carefully every time 
to the brief and come up with something that hits the spot across a range of disciplines.”
</p>
							</div>
							<div class="text-color-1 small-title-oswald">
								 Maddipatla Gopidhar ,<span class="text-color-2">Principal consultant 
360 degree Hospitality services.</span>
							</div>
						</div><!-- slide end -->
						<!-- slide start -->
						<div class="swiper-slide text-center">
							<img src="assets/images/testimonials/hycon.png" alt="author">
							<div class="testimonials-content">
								<p class="text-color-4 p-style-bold">"Ashvaa Creative co" …. a very passionate, Incredible creative minds, affordable and reliable services.
I really appreciate their support for business branding and marketing</p>
							</div>
							<div class="text-color-1 small-title-oswald">
								Vasu Adapa, <span class="text-color-2">Managing Director, Hycon Designs</span>
							</div>
						</div><!-- slide end -->
					</div><!-- swiper-wrapper end -->
			...
			<div class="video-content-bg" style="background-image:url(assets/images/backgrounds/business-calligraphy-chinese-lanterns-1455969.jpg)">
				...
				<a href="https://www.youtube.com/watch?v=0MJ6v9WszfE" class="video-play-button popup-youtube pointer-large">
					<span></span>
				</a>
					...
					<div class="flex-container response-999 top-padding-60">
						...
						<div class="four-columns bottom-padding-90">
							<article class="content-right-margin-20 light-bg-2" data-animation-container>
								<a href="blog.php" class="pointer-large animsition-link hover-box d-block">
									...
									<h3 class="title-style text-color-1 top-margin-30 blog-title content-padding-l-r-20">
										<span data-animation-child class="overlay-anim-box2 hover-content overlay-dark-bg-2 tr-delay01" data-animation="overlay-anim2">How To</span><br>
										<span data-animation-child class="overlay-anim-box2 hover-content overlay-dark-bg-2 tr-delay02" data-animation="overlay-anim2">Choose a </span><br>
										<span data-animation-child class="overlay-anim-box2 hover-content overlay-dark-bg-2 tr-delay03" data-animation="overlay-anim2">Brand Name </span>
									</h3>
								</a>
			                  ...
			                  <!--      <ul data-animation-child class="blog-tags top-margin-10 fade-anim-box tr-delay05 text-color-2" data-animation="fade-anim">
		                            ...
		                            <div data-animation-child class="blog-autor-date top-margin-30 fade-anim-box tr-delay06 text-color-1" data-animation="fade-anim">
										...
										<a class="xsmall-title-oswald pointer-small hover-color" href="#">May 20, 2020</a>
		                            </div>
								</div>					
							</article>
						</div><!-- column end -->
							...
							<article class="content-left-right-margin-10 light-bg-2" data-animation-container>
								<a href="blog.php" class="pointer-large animsition-link hover-box d-block">
									...
									<h3 class="title-style text-color-1 top-margin-30 blog-title content-padding-l-r-20">
										...
										<span data-animation-child class="overlay-anim-box2 hover-content overlay-dark-bg-2 tr-delay02" data-animation="overlay-anim2">Effected </span><br>
										<span data-animation-child class="overlay-anim-box2 hover-content overlay-dark-bg-2 tr-delay03" data-animation="overlay-anim2">Your Business ?</span>
									</h3>
								</a>
								<div class="content-padding-bottom-20 content-padding-l-r-20">
									<ul data-animation-child class="blog-category top-margin-30 fade-anim-box tr-delay04 text-color-2" data-animation="fade-anim">
		                         ...
		                         <!--   <ul data-animation-child class="blog-tags top-margin-10 fade-anim-box tr-delay05 text-color-2" data-animation="fade-anim">
		                            ...
		                            <div data-animation-child class="blog-autor-date top-margin-30 fade-anim-box tr-delay06 text-color-1" data-animation="fade-anim">
		                            	<a class="xsmall-title-oswald pointer-small hover-color" href="#">Mahendra</a>
										<a class="xsmall-title-oswald pointer-small hover-color" href="#">June 13, 2020</a>
		                            </div>		
								</div>						
							</article>
						</div><!-- column end -->
						...
						<div class="four-columns bottom-padding-90">
							<article class="content-left-margin-20 light-bg-2" data-animation-container>
								<a href="blog-title.php" class="pointer-large animsition-link hover-box d-block">
									<div class="overlay-anim-box2 overlay-dark-bg-2" data-animation="overlay-anim2">
										<img class="hover-img" src="assets/images/blog/smc.jpg" alt="blog img">
									</div>
									<h3 class="title-style text-color-1 top-margin-30 blog-title content-padding-l-r-20">
										<span data-animation-child class="overlay-anim-box2 hover-content overlay-dark-bg-2 tr-delay01" data-animation="overlay-anim2">Lockdown </span><br>
										<span data-animation-child class="overlay-anim-box2 hover-content overlay-dark-bg-2 tr-delay02" data-animation="overlay-anim2">has</span><br>
										<span data-animation-child class="overlay-anim-box2 hover-content overlay-dark-bg-2 tr-delay03" data-animation="overlay-anim2">affected many business</span>
									</h3>
								</a>
								<div class="content-padding-bottom-20 content-padding-l-r-20">
									<ul data-animation-child class="blog-category top-margin-30 fade-anim-box tr-delay04 text-color-2" data-animation="fade-anim">
		                         ...
		                         <!--   <ul data-animation-child class="blog-tags top-margin-10 fade-anim-box tr-delay05 text-color-2" data-animation="fade-anim">
		                            ...
		                            <div data-animation-child class="blog-autor-date top-margin-30 fade-anim-box tr-delay06 text-color-1" data-animation="fade-anim">
		                            	<a class="xsmall-title-oswald pointer-small hover-color" href="#">Akhil</a>
										<a class="xsmall-title-oswald pointer-small hover-color" href="#">May 10, 2020</a>
		                            </div>								
								</div>
							</article>
						</div><!-- column end -->
				...
				<div class="three-columns bottom-padding-60">
					<div class="content-left-right-margin-10">
						<ul class="footer-menu text-color-4">
							...
							<li><a class="pointer-large animsition-link small-title-oswald hover-color" href="blog.php">Blog</a></li>
							<li><a class="pointer-large animsition-link small-title-oswald hover-color" href="contact.php">Contact</a></li>
						</ul>
					</div>
				</div><!-- column end -->
				<!-- column start -->
