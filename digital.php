	...
	<body class="loader">
		...
		<main class="animsition-overlay" data-animsition-overlay="true">
			...
			<section id="up" class="page-head flex-min-height-box dark-bg-2">
				<!-- page-head-bg -->
				<div class="page-head-bg overlay-loading2" style="background-image: url(assets/images/blog/digital.jpg);"></div>
			  			...
			  			<div class="six-columns six-offset">
				  			<div class="content-left-margin-40">
				  				<h2 class="large-title">
									<span class="load-title-fill tr-delay03" data-text="Almost">Almost </span><br>
									<span class="load-title-fill tr-delay04" data-text="entire">entire</span><br>
									<span class="load-title-fill tr-delay05" data-text="world is in lockdown">world is in lockdown</span>
								</h2>
								<div class="d-flex-wrap top-margin-20">
									...
									<a class="small-title-oswald text-height-20 pointer-large load-title-fill tr-delay07 top-margin-10" href="#" data-text="By: Mahendra">By: Nahendra</a>
									<a class="small-title-oswald text-height-20 pointer-large load-title-fill tr-delay08 top-margin-10" href="#" data-text="2020, May 9">2020, May 9</a>
								</div>
				  			</div>
			  			</div><!-- column end -->
				...
				<div class="flex-container">
					...
					<div class="eight-columns">
						...
						<div class="light-bg-2">
							<a class="photo-popup pointer-zoom" href="assets/images/blog/digital.jpg">
								<img src="assets/images/blog/digital.jpg" alt="title">
							</a>
							<!-- content-margin-block start -->
							<div class="content-margin-block">
								<!-- entry-content start -->
								<article class="entry-content">
									<p class="p-style-medium text-color-1">Now how do you start talking to your potential customers and get ready with a post-lockdown preparation?
 we’ve got your back. We recommend you to calm down, put a pen to paper, and start gathering your business plans. Digital Marketing can be your go-to strategy and activity, at least going forward when staying indoors might become the normal.
There are number of tools within the confines of Digital Marketing you can maximize on. The firstly you need to adapt yourself to the world of Digital Marketing in the times of COVID-19.
</p>
									<p class="p-style-medium text-color-1">Let’s move to the Digital Marketing and what all can you do under it
Digital Marketing
The Digital age has long arrived. There are several tools you can make the most of, SEO (Search Engine Optimization), SMM (Social Media Marketing), Google Ads campaign, PPC (Pay Per Click), Blogs, etc. All of these can generate sales through your website.


Social Media Marketing
For many, the source of Entertainment and Knowledge is Social Media. Since the start of the lockdown, lot of people have been spending much time on online – mostly on the Social. From Facebook to TikTok, there’s a world of Social Media platforms to put your brand on.


</p>
									<blockquote class="quote-content">
										<p class="p-style-bold text-justify text-color-4">Tip 2:
Now is the time to be noticed by the audience. Because staying indoors is one major advice that would help in keeping yourself away from COVID-19. And this is when people are glued-in to their screens for amusement, which means, it’s chance for your brand to be identified and heard right when you want.

</p>
									</blockquote>
									<h2 class="title-style text-color-1 top-margin-30 text-center"></h2>
									<p class="p-style-medium text-color-1">Content Marketing
There are several content platforms, where your brand can be showed up. A lot of entertainment is being consumed on online. we have options all the way from news websites, YouTube videos, OTT apps, e-newspapers and e-magazines.
								...
								<!--	<div class="post-img-flex">
									...
									<p class="p-style-medium text-color-1">SMS Marketing
It’s a potentially way to reach out to your customers if you are smart about the messaging. All you have is 160 characters to communicate your selling proposition. But then, it is also the quickest way to reach out to them and make sale happen.
All in these are times when you should set forth with new ways to make your brand seen – ASHVAA CREATIVE CO can help you in putting your brand on Digital platforms right from scratch.
...
<!-- Mirrored from www.nurseitmukaytegin.com/envato-templates/xen/single_post.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Mar 2020 06:46:09 GMT -->
</html>