	...
	<body class="loader">
		...
		<main class="animsition-overlay" data-animsition-overlay="true">
			...
			<section id="up" class="page-head flex-min-height-box dark-bg-1">
				<!-- page-head-bg -->
				<div class="page-head-bg overlay-loading2" style="background-image: url(assets/images/pj/2.jpg);"></div>
			  			...
			  			<div class="six-columns six-offset">
				  			<div class="content-left-margin-40">
				  				<h2 class="large-title">
									<span class="load-title-fill tr-delay03" data-text="CREDAI">CREDAI</span><br>
									<span class="load-title-fill tr-delay04" data-text="HOME EXPO -2017">HOME EXPO -2017</span><br>
									<span class="load-title-fill tr-delay05" data-text="KAKINADA">KAKINADA</span>
								</h2>
								<ul class="d-flex-wrap top-margin-20">
									<li class="small-title-oswald text-height-20 load-title-fill tr-delay06 top-margin-10" data-text="CREDAI">CREDAI</li>
									<li class="small-title-oswald text-height-20 load-title-fill tr-delay07 top-margin-10" data-text="YEAR: 2017">YEAR:2017</li>
									<li class="small-title-oswald text-height-20 load-title-fill tr-delay08 top-margin-10" data-text="ROLE:EXHIBITION">ROLE:EXHIBITION</li>
								</ul>
				  			</div>
			  			</div><!-- column end -->
			...
			<div class="light-bg-1 top-padding-120 bottom-padding-60" data-midnight="black">
				...
				<div class="flex-container container project-content">
					...
					<div class="four-columns bottom-padding-60">
						<div class="content-right-margin-20">
							<a class="photo-popup pointer-zoom" href="assets/images/Mockups/cre/1.jpg">
								<img src="assets/images/Mockups/cre/1.jpg" alt="title">
							</a>
						</div>
					</div><!-- column end -->
					<!-- column start -->
					<div class="four-columns bottom-padding-60">
						<div class="content-left-right-margin-10">
							<a class="photo-popup pointer-zoom" href="assets/images/Mockups/cre/2.jpg">
								<img src="assets/images/Mockups/cre/2.jpg" alt="title">
							</a>
						</div>
					</div><!-- column end -->
					<!-- column start -->
					<div class="four-columns bottom-padding-60">
						<div class="content-left-margin-20">
							<a class="photo-popup pointer-zoom" href="assets/images/Mockups/cre/3.jpg">
								<img src="assets/images/Mockups/cre/3.jpg" alt="title">
							</a>
						</div>
					</div><!-- column end -->
				</div><!-- flex-container end -->
