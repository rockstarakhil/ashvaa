...
<!-- Mirrored from www.nurseitmukaytegin.com/envato-templates/xen/project.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Mar 2020 06:43:53 GMT -->
	...
	<body class="loader">
		...
		<main class="animsition-overlay" data-animsition-overlay="true">
			...
			<section id="up" class="page-head flex-min-height-box dark-bg-1">
				<!-- page-head-bg -->
				<div class="page-head-bg overlay-loading2" style="background-image: url(assets/images/projects/pexels-photo-1619654.jpg);"></div>
			...
			<div class="light-bg-1 top-padding-120 bottom-padding-60" data-midnight="black">
				...
				<div class="flex-container container project-content">
					...
					<div class="four-columns bottom-padding-60">
						<div class="content-right-margin-20">
							<a class="photo-popup pointer-zoom" href="assets/images/projects/pexels-photo-1093236.jpg">
								<img src="assets/images/projects/pexels-photo-1093236.jpg" alt="title">
							</a>
						</div>
					</div><!-- column end -->
					<!-- column start -->
					...
					<div class="four-columns bottom-padding-60">
						<div class="content-left-margin-20">
							<a class="photo-popup pointer-zoom" href="assets/images/projects/pexels-photo-544491.jpg">
								<img src="assets/images/projects/pexels-photo-544491.jpg" alt="title">
							</a>
						</div>
					</div><!-- column end -->
				</div><!-- flex-container end -->
